...
fun JournalEntryEntity.toDomain() =
    JournalEntry(id, title, content, imagePath, imageUrl, createdAt, updatedAt, isSynced)

fun JournalEntry.toEntity() =
    JournalEntryEntity(id, title, content, imagePath, imageUrl, createdAt, updatedAt, isSynced)